...
public class MinioObjectReadException extends CustomServerException {
    public MinioObjectReadException(String objectKey, Throwable cause, ServerErrorLevel serverErrorLevel) {
        super("MinIO 객체를 조회하지 못했습니다. objectKey=" + objectKey, cause, serverErrorLevel);
    }
}
