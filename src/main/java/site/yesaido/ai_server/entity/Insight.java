...
public class Insight {
    ...
    @Builder
    public Insight(Long cultivationId, Long mushroomId, Double avgTemperature, Double avgHumidity,
                   Double avgCo2, Double avgLight, Double harvestWeightGrams, Integer growthScore, String summary) {
