...
public class TestController {
    ...
    public MushService.MushroomGuideResponse testGuide(
            @RequestParam(defaultValue = "1") Long mushroomId,
        ...
        return mushService.generateRealDataGuide(mushroomId, name, "");
    }

    @GetMapping("/api/test/load-vector")
    public String loadVector(){
        return mushVectorService.loadCsv();
    }
}
